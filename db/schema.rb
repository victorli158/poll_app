...
ActiveRecord::Schema.define(version: 20170413204338) do
  ...
  create_table "responses", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["user_id", "answer_choice_id"], name: "index_responses_on_user_id_and_answer_choice_id", unique: true, using: :btree
  end
